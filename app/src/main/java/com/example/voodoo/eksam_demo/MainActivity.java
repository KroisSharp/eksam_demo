...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageView StatusBillede;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StatusBillede = findViewById(R.id.pic_Billede);
    ...
    public void clk_Start(View view) {
        Log.d(TAG, "clk_Start: Starter");
        StartLocation();

        StartGeofence(55.635367,12.089943, 250, "gul",2);
        StartGeofence(55.637347,12.087529, 250, "vinder",1);
        StatusBillede.setVisibility(View.VISIBLE);
    }
    ...
    private void StartGeofence(double latitude, double longitude, float radius, String GEOFENCE_ID, int reqcode) {
        ...
        try {
            ...
            PendingIntent pendingIntent = PendingIntent.getService(this, reqcode, intent, PendingIntent.FLAG_UPDATE_CURRENT);
